...
boolean menu(StuList *plist) {
	...
	switch (order) {
		...
		case 6 : insertOneStudent(plist);	 				 break;
	...
	if(order != 1 && order != 5 && order != 7 && order != 8 && order != 9 && order!=10) {
		printf("是否输出查看?(Y/N)\n");
		scanf("%1s",choice);
		!strcmp(choice,"Y") ? display(plist) : 0; 
		fflush(stdin);
	}
...
void show(void) {
	system("cls");
		...
		printf("\t\t*************************************************************************************\n");
		printf("\t\t*                                                                                   *\n");
		printf("\t\t*             1. 录入学生信息                  2. 排名                              *\n");
		printf("\t\t*                                                                                   *\n");
		printf("\t\t*             3. 修改学生信息                  4. 删除                              *\n");
		printf("\t\t*                                                                                   *\n");
		printf("\t\t*             5. 显示学生成绩                  6. 增添                              *\n");
		printf("\t\t*                                                                                   *\n");
		printf("\t\t*             7. 打印学生信息                  8. 筛选                              *\n");
		printf("\t\t*                                                                              	    *\n");
		printf("\t\t*             9. 搜索                          10.退出系统                          *\n");
		printf("\t\t*                                                                                   *\n");
		printf("\t\t*************************************************************************************\n\n");
